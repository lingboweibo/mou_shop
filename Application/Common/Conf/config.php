...
return array(
    ...
    'DB_NAME'   => 'mou_shop', // 数据库名
    'DB_USER'   => 'root', // 用户名
    'DB_PWD'    => '123456', // 密码 密码如果不对 会出这样的错误 ：SQLSTATE[HY000] [1045] Access denied for user 'root'@'localhost' (using password: YES)
    'DB_PORT'   => 3306, // 端口
    ...
    'PAY_NAME'  =>array('货到付现金','货到刷银行卡','城市超市礼品卡支付','使用会员卡支付'),  //支付方式(供前台页面的订单操作调用)
);